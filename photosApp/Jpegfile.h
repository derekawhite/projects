...
public:
	...
	static BYTE * JpegFileToRGB(const char * fileName,			// path to image
	...
	static BOOL RGBToJpegFile(const char * fileName,				// path
	...
	static BOOL GetJPGDimensions(const char * fileName,			// path
								UINT *width,				// pixels
								UINT *height);
